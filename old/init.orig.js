...
module.exports = {
  ...
  async handler(context) {
    ...
    console.log('    Add project to coveralls: https://coveralls.io/repos/new');
    console.log('    Add repo token to Circle CI as COVERALLS_REPO_TOKEN');
    console.log('    Set coveralls to not allow more than 0.1% coverage decrease');
    console.log('    Set coveralls as required check');
...
async function minimal(context) {
  const localRepo = await getOrCreateLocalRepo();
